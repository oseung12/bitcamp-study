...
public class Exam1 {
  ...
  //변수 선언 : JVM에게 값을 저장할 메모리를 준비시키는 명령문
  //테스트 URL
  @GetMapping("/test1")
  ...
  //- 메모리 크기에 따른 값의 유효범위
  //테스트 URL:
  //http://localhost:8080/lang/variable/exam1/test3?f=987.65432&d=987654.321234
  @GetMapping("/test3")
  ...
  //- 논리 값으로 1/0, TRUE/FALSE를 사용할 수 있는 이유는
  //  스프링 부트가 중간에서 값으로 변환해주기 때문이다.
  @GetMapping("/test5")
