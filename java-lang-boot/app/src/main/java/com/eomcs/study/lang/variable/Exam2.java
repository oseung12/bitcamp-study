...
@RestController("lang.variable.exam2") // 클래스 이름이 같은 경우 충돌 방지 => 클래스 이름표
@RequestMapping("/lang/variable/exam2") // 웹브라우저에서 실행할 경로명
public class Exam2 {

  //여러 개의 값을 받는 방법 : 배열 사용 전
  //http://localhost:8080/lang/variable/exam2/test1?name1=홍길동&name2=임꺽정&name3=유관순&
  // name4=안중근&name5=윤봉길&name6=김구&name7=홍범도
  @GetMapping("/test1")
  ...
  //http://localhost:8080/lang/variable/exam2/test2?name=홍길동&name=&name=유관순&
  // name=안중근&name=윤봉길&name=김구&name=홍범도
  @GetMapping("/test2")
