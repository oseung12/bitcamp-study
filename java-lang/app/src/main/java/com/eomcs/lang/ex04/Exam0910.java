...
public class Exam0910 {
  public static void main(String[] args) {
    byte b = 100; // 1byte
    short v1 = b; // 1byte를 2byte 메모리에 넣는다.

    short s = 100; // 2byte (-32768 ~ 32767)
    int v2 = s; // 2byte를 4byte 메모리에 넣는다.

    int i = 98765678; //4byte
    long v3 = i; // 4byte ==> 8byet

    long l = 98765678; // 8byte

    char c = 100; // 2byte(0 ~ 65535)
    // short x1 = c;  //  char(양의 정수만 저장하는 2byte // 0 ~ 65535) 
    //   ==> short(-32768 ~ 32767), 값의 범위가 맞지 않아 컴파일 오류!      
  }
}
