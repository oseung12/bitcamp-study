...
CREATE TABLE lms_mgr (
  ...
  pono    INTEGER     NULL     COMMENT '직급번호', -- 직급번호
  ext_tel VARCHAR(30) NOT NULL COMMENT '사내전화번호', -- 사내전화번호
...
CREATE TABLE lms_member (
  mon      INTEGER      NOT NULL COMMENT '회원번호', -- 회원번호
...
ALTER TABLE lms_member
  MODIFY COLUMN mon INTEGER NOT NULL AUTO_INCREMENT COMMENT '회원번호';
